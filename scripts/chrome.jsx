...
function Footer({ onNav }) {
  const cols = [
    { title: 'Compliance', items: [
      ...
      ['VAT registration', 'service-vat-registration'],
      ['UAE Corporate Tax', 'service-corporate-tax'],
      ['Corporate Tax filing', 'service-ct-filing'],
      ['VAT return filing', 'service-vat-filing'],
      ['VAT refunds', 'service-vat-refund'],
    ...
    { title: 'Advisory', items: [
      ...
      ['Internal controls', 'service-internal-controls'],
      ['Financial modeling', 'service-financial-modelling'],
      ['CFO services', 'service-cfo'],
      ['Tax planning', 'service-tax-planning'],
      ['Tax advisory', 'service-tax-advisory'],
      ['Transfer pricing', 'service-transfer-pricing'],
...
const SEARCH_PAGES = [
  ...
  ['service-ct-filing', 'Corporate Tax Filing', 'ct return filing 9 months deadline emaratax annual'],
  ['service-vat-filing', 'VAT Return Filing', 'vat201 quarterly return filing 28 days deadline'],
  ['service-vat-refund', 'VAT Refunds', 'vat refund claim vat311 input recovery fta'],
  ['service-tax-advisory', 'Tax Advisory', 'tax consultant advisor advisory uae dubai clarification'],
  ['service-transfer-pricing', 'Transfer Pricing', 'transfer pricing tp study documentation master local file arm length related party oecd'],
  ['service-vat-registration', 'VAT Registration', 'vat registration trn threshold 375000 emaratax tax group register'],
  ['location-abu-dhabi', 'Abu Dhabi', 'accounting tax services abu dhabi adgm'],
  ['location-sharjah', 'Sharjah', 'accounting tax services sharjah hamriyah saif'],
  ['location-ajman', 'Ajman', 'accounting tax services ajman free zone'],
  ['location-ras-al-khaimah', 'Ras Al Khaimah', 'accounting tax services rak rakez asset tagging'],
  ['location-fujairah', 'Fujairah', 'accounting tax services fujairah foiz port'],
  ['location-umm-al-quwain', 'Umm Al Quwain', 'accounting tax services uaq asset tagging'],
