  ...
  return (
    <section id={id} style={{ marginTop: 48 }}>
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 16, borderTop: '2px solid var(--aa-charcoal)', paddingTop: 18 }}>
        <span className="mono" style={{ color: 'var(--aa-cyan-text)', fontSize: 13, fontWeight: 600, letterSpacing: '0.06em' }}>
    ...
    <div>
      ...
      <PolicyBody>
        <PolicySection n={1} title="Who we are" id="who">
          ...
          <P>For any privacy-related question, contact us at <a href="mailto:info@aaccounting.me" style={{ color: 'var(--aa-cyan-text)' }}>info@aaccounting.me</a> or <a href="tel:+97143960399" style={{ color: 'var(--aa-cyan-text)' }}>+971 4 396 0399</a>.</P>
        </PolicySection>
        ...
        <PolicySection n={7} title="Your rights" id="rights">
          ...
          <P>To exercise any of these rights, email <a href="mailto:info@aaccounting.me" style={{ color: 'var(--aa-cyan-text)' }}>info@aaccounting.me</a>. We aim to respond within 30 days and, where applicable, within the timelines set out by the UAE Data Office.</P>
        </PolicySection>
        ...
        <PolicySection n={11} title="Contact" id="contact">
          ...
          <P>
            ...
            <a href="mailto:info@aaccounting.me" style={{ color: 'var(--aa-cyan-text)' }}>info@aaccounting.me</a> &middot; <a href="tel:+97143960399" style={{ color: 'var(--aa-cyan-text)' }}>+971 4 396 0399</a>
          </P>
        </PolicySection>
    ...
    <div>
      ...
      <PolicyBody>
        ...
        <PolicySection n={6} title="Confidentiality of communications" id="confidential">
          <P>Communications sent through the website&rsquo;s contact form or by email are not, of themselves, privileged or confidential beyond what applies under general law. You should not send highly sensitive information through the website without prior arrangement. The handling of personal information is governed by our <a href={pathForPolicyPage('privacy')} onClick={(e) => { e.preventDefault(); onNav('privacy'); }} style={{ color: 'var(--aa-cyan-text)' }}>Privacy Policy</a>.</P>
        </PolicySection>
