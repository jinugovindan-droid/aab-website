...
INSIGHTS = [
    ...
    {"slug": "choosing-accredited-service-provider-asp",
     "seoTitle": "UAE E-Invoicing ASP List: 54 Accredited Providers (Sep 2026)", "seoDesc": "The Ministry of Finance accredited service provider list for UAE e-invoicing: 54 providers at 17 September 2026, 8 under final assessment, and what to ask.", "tag": "E-Invoicing", "date": "22 Jan 2026",
...
# VAT calculator FAQ (keep in sync with scripts/routes.js)
VAT_CALC_FAQ = [
...
FAQ_BY_PAGE = {
    ...
    "tool-vat": VAT_CALC_FAQ,
}

# Answer-first capsules for the money pages — mirror of routes.js ANSWER_FIRST.
ANSWER_FIRST = {
    "tool-vat": {"h": "How do you calculate 5% VAT in the UAE?", "text":
...
TOOL_SLUGS = {"tool-gratuity": "gratuity-calculator", "tool-vat": "vat-calculator"}
TOOL_CHUNKS = {}
try:
