          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 64, alignItems: 'end' }}>
            <div>
              ...
              <h1 style={{
                ...
                <span style={{ color: 'var(--aa-cyan-text)' }}>sector-bound</span>.
              </h1>
            </div>
          ...
          <div className="aa-grid-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, border: '1px solid var(--aa-rule)', background: '#fff' }}>
            {[
              ...
              <a key={pg} href={pathForPage(pg)} onClick={(e) => { e.preventDefault(); onNav(pg); }}
                ...
                <div style={{ marginTop: 'auto', paddingTop: 10, color: 'var(--aa-cyan-text)', fontWeight: 600, fontSize: 13 }}>Explore →</div>
              </a>
            ))}
          </div>
        </div>
      ...
      <section className="aa-hero-image" style={{ position: 'relative', overflow: 'hidden', borderBottom: '1px solid var(--aa-rule)', padding: '88px 0 96px' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <h1 style={{
            ...
            Many hands. One framework.<br />Built on <span style={{ color: 'var(--aa-cyan-text)' }}>controls</span>.
          </h1>
                ...
                <div className="aa-traj-grid">
                  {TRAJ.map(([yr, , label, t, d]) => (
                    <div key={yr} style={{ borderTop: '1px solid var(--aa-rule-strong)' }}>
                      ...
                      <div className="mono" style={{ fontSize: 13, color: 'var(--aa-cyan-text)', fontWeight: 600 }}>{yr}</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, borderTop: '1px solid var(--aa-rule)', borderLeft: '1px solid var(--aa-rule)' }}>
            ...
            <div key={p.name} style={{
              ...
              minHeight: 240, background: '#fff'
                ...
                <div style={{
                width: 64, height: 64,
                background: 'var(--aa-charcoal)', '--aa-cyan-text': 'var(--aa-cyan)',
                color: '#fff',
      ...
      <section className="section section--dark">
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 1, background: 'rgba(255,255,255,0.08)' }}>
            ...
            map(([k, v]) =>
            <div key={k} style={{ background: 'var(--aa-charcoal)', '--aa-cyan-text': 'var(--aa-cyan)', padding: '20px 24px', display: 'flex', justifyContent: 'space-between' }}>
...
function EInvoiceCTA({ onNav }) {
  return (
    <div style={{ background: 'var(--aa-charcoal)', '--aa-cyan-text': 'var(--aa-cyan)', color: '#fff', padding: 28, marginTop: 40 }}>
    ...
    <div className="container" style={ART}>
      ...
      <div style={{ marginTop: 28, borderTop: '1px solid var(--aa-rule)', paddingTop: 20 }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 0, listStyle: 'none', display: 'grid', gap: 8, fontSize: 15 }}>
          ...
          <li><a href={pathForInsight('free-zone-qualifying-income')} onClick={(e) => { e.preventDefault(); onNav('insight', 'free-zone-qualifying-income'); }} style={{ color: 'var(--aa-cyan-text)', fontWeight: 600, textDecoration: 'none' }}>Free zone qualifying income — three traps →</a></li>
        </ul>
      </div>
    </div>
  );
    ...
    <div className="container" style={ART}>
      ...
      <div style={{ marginTop: 28, borderTop: '1px solid var(--aa-rule)', paddingTop: 20 }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 0, listStyle: 'none', display: 'grid', gap: 8, fontSize: 15 }}>
          ...
          <li>{link('service-corporate-tax', 'UAE Corporate Tax compliance →')}</li>
          <li><a href={pathForInsight('uae-corporate-tax-guide-sme')} onClick={(e) => { e.preventDefault(); onNav('insight', 'uae-corporate-tax-guide-sme'); }} style={{ color: 'var(--aa-cyan-text)', fontWeight: 600, textDecoration: 'none' }}>UAE Corporate Tax: a complete guide →</a></li>
        </ul>
      </div>
    </div>
  );
    ...
    <figure className="aa-figwide" style={FIG}>
      <div style={{ overflowX: 'auto' }}>
        ...
        >
          ...
          <text x="408" y="176" style={oText}><tspan x="408">Article 54 bis(1). Once the</tspan><tspan x="408" dy="16">connection is established: shall, not may.</tspan></text>
  ...
  const SupplierCheckTool = () => {
    ...
    return (
      <div style={{ margin: '34px 0 38px', border: '1px solid var(--aa-rule)', borderRadius: 4, overflow: 'hidden' }}>
        <div style={{ background: 'var(--aa-charcoal)', '--aa-cyan-text': 'var(--aa-cyan)', padding: '16px 22px' }}>
          <div className="eyebrow" style={{ color: 'var(--aa-cyan-text)', margin: 0 }}>Check one supplier</div>
  ...
  return (
    <div className="container" style={ART}>
      ...
      <div style={{ margin: '24px 0 26px', borderLeft: '3px solid var(--aa-cyan)', paddingLeft: 22, fontSize: 15.5, lineHeight: 1.6, color: 'var(--aa-charcoal-800)' }}>
        ...
        <p><strong>2.</strong> The Authority <strong>may</strong> reject the deduction of recoverable input tax if it is established that the supply in respect of which the deduction is claimed was part of a supply or a chain of supplies connected with tax evasion, and that, having regard to the circumstances of the supply, the Taxable Person should have known of such connection.</p>
        <p style={{ marginBottom: 0 }}><strong>3.</strong> For the purposes of applying the provisions of Clause (2) of this Article, a Taxable Person <strong>shall</strong> be deemed to have been required to know that the supply was part of a supply or a chain of supplies connected with tax evasion where the Taxable Person failed to verify the validity and integrity of the supplies received prior to deducting input tax, in accordance with the measures, procedures, and conditions determined by the Authority in this regard.</p>
      </div>
      <p>Quoted as printed, with the emphasis ours, and including the slip in clause&nbsp;1 where &ldquo;the Taxable&rdquo; plainly means the Taxable Person. The FTA&rsquo;s own consolidation of the VAT Law renders the same Arabic a little differently in English &mdash; &ldquo;related to Tax Evasion&rdquo; rather than &ldquo;connected with tax evasion&rdquo;, &ldquo;aware&rdquo; rather than &ldquo;knew&rdquo;. Nothing turns on the difference, and the Arabic governs either way.</p>
      <p>Note the verbs, because they are carrying the whole architecture. Rejection is <strong>shall</strong> in clause&nbsp;1 and <strong>may</strong> in clause&nbsp;2 &mdash; mandatory where you knew, discretionary where you merely should have known. The <strong>shall</strong> in clause&nbsp;3 is doing something different: it is not about rejecting anything, it makes the <em>deeming</em> automatic. And that third clause is where Decision&nbsp;13 attaches: a taxable person is treated as having been required to be aware if they did not verify the validity and integrity of the supplies they received, in accordance with the measures the Authority determines. That deeming feeds the <strong>second</strong> limb only &mdash; the discretionary one.</p>
      ...
      <p>One thing to be clear about, because the language is alarming and the effect is narrower than it sounds. <strong>Tax Evasion</strong> here is a defined term, not a loose description: the Tax Procedures Law defines it as a person&rsquo;s use of <em>illegal means</em> resulting in a reduction of the tax due, non-payment of it, or a refund nobody was entitled to. And the evasion Article&nbsp;54&nbsp;bis is concerned with is <strong>somebody else&rsquo;s</strong>, somewhere in the chain behind your invoice. Failing these checks does not make you a tax evader, and none of this is an allegation against you &mdash; it goes only to whether you should have known about another party&rsquo;s conduct.</p>
      ...
      <div style={{ marginTop: 22, padding: '20px 22px', border: '1px solid var(--aa-cyan)', borderRadius: 4 }}>
        <div className="eyebrow eyebrow--charcoal" style={{ marginBottom: 10 }}>We can write this one for you</div>
        <p style={{ margin: 0, fontSize: 15.5 }}>The policy is a short document, but it has to name the right people and match how your purchase ledger actually runs &mdash; a template with the wrong names in it is worse than none. We draft it alongside the rolling 12-month supplier analysis that tells you which suppliers sit above AED&nbsp;100,000 and AED&nbsp;375,000, because those two numbers decide how much of this Decision applies to you at all. {link('contact', 'Talk to us before 1 October →')}</p>
      </div>
      ...
      <h3 style={H3}>Two things the Decision leaves open</h3>
...
function ERAmendments2026Body({ onNav }) {
  ...
  return (
    <div className="container" style={ART}>
      ...
      <div style={{ overflowX: 'auto', marginTop: 8 }}>
        <table className="aa-table" style={{ width: '100%' }}>
          ...
          <tbody>
            ...
            <tr><td className="aa-num" style={NUM}><strong>52(2)</strong></td><td style={TD}>A person is &ldquo;outside the State&rdquo; if present for less than 30 days (was &ldquo;less than a month&rdquo;) and the presence is not effectively connected with the supply</td><td style={NUM}>1 Oct 2026</td></tr>
      ...
      <p>This is the largest change and the one with the longest fuse. A business that makes both taxable and exempt supplies recovers input tax on its shared costs &mdash; rent, IT, audit fees &mdash; in proportion. Today, under Article&nbsp;55(7) and as the FTA&rsquo;s apportionment guide sets it out, the proportion is <strong>a&nbsp;&divide;&nbsp;(a&nbsp;+&nbsp;b)</strong>: input tax wholly attributable to taxable supplies over the sum of that and input tax wholly attributable to exempt supplies, rounded to a whole number, applied to the residual. From the first tax year commencing after 1&nbsp;October&nbsp;2027 the ratio is <strong>the value of supplies under Article&nbsp;54(1) of the Decree-Law over the total value of all supplies</strong> &mdash; broadly taxable turnover over total turnover &mdash; with the sale of capital assets and reverse-charge receipts under Article&nbsp;48 left out of the calculation, again rounded to a whole number.</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 64, alignItems: 'end' }}>
            <div>
              ...
              <h1 style={{
                ...
                We hire every quarter. For <span style={{ color: 'var(--aa-cyan-text)' }}>ourselves</span> — and for our clients.
              </h1>
            </div>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ marginTop: 14, fontSize: 12.5, color: 'var(--aa-steel)', lineHeight: 1.55 }}>
                By sending your CV you consent to Authentic Accounting storing and processing it &mdash; including automated indexing to match you to roles, always with a partner&rsquo;s review before any contact &mdash; as described in our <a href={pathForPage('privacy')} onClick={(e) => { e.preventDefault(); onNav('privacy'); }} style={{ color: 'var(--aa-cyan-text)', fontWeight: 600 }}>Privacy Policy</a>. We keep it for 18&nbsp;months; withdraw any time.
              </p>
            </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
                {[
                  ...
                  <div key={n} style={{ display: 'grid', gridTemplateColumns: '40px 1fr', gap: 14 }}>
                    <div className="mono" style={{ fontSize: 12, letterSpacing: '0.12em', color: 'var(--aa-cyan-text)', paddingTop: 3 }}>{n}</div>
                    <div>
            ...
            <div style={{ padding: 32, minHeight: 380 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  ...
                  <button key={s} onClick={() => toggleService(s)} aria-pressed={on} style={{
                    ...
                    <span>{s}</span>
                    {on && <span aria-hidden="true" style={{ color: 'var(--aa-cyan-text)', fontWeight: 700 }}>✓</span>}
                  </button>
                      );
                    })}
                  </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  ...
                  <div style={{
                    ...
                    <button onClick={() => setStep(1)} style={{
                      ...
                      color: 'var(--aa-cyan-text)', fontSize: 12, fontWeight: 600,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  <label style={{ display: 'flex', gap: 10, alignItems: 'flex-start', fontSize: 13, color: 'var(--aa-steel-700)', lineHeight: 1.55, cursor: 'pointer' }}>
                    ...
                    <span>I agree to Authentic Accounting processing my details to respond to my enquiry, as described in the <a href={pathForPage('privacy')} onClick={(e) => { e.preventDefault(); onNav('privacy'); }} style={{ color: 'var(--aa-cyan-text)', fontWeight: 600 }}>Privacy Policy</a>. <span style={{ color: 'var(--aa-negative)' }}>*</span></span>
                  </label>
                  <label style={{ display: 'flex', gap: 10, alignItems: 'flex-start', fontSize: 13, color: 'var(--aa-steel-700)', lineHeight: 1.55, cursor: 'pointer' }}>
          ...
          <div style={{ borderTop: '2px solid var(--aa-charcoal)' }}>
            {cfg.demand.map(([pg, label, d]) => (
              <a key={pg + label} className="aa-demand-row" href={pathForPage(pg)} onClick={(e) => { e.preventDefault(); onNav(pg); }}
                ...
                <span style={{ fontSize: 14, color: 'var(--aa-steel-700)', textAlign: 'right' }}>{d} <span style={{ color: 'var(--aa-cyan-text)', fontWeight: 600 }}>→</span></span>
              </a>
            ))}
          </div>
