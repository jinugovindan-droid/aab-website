  ...
  return (
    <div className="container" style={ART}>
      ...
      <div style={{ margin: '24px 0 26px', borderLeft: '3px solid var(--aa-cyan)', paddingLeft: 22, fontSize: 15.5, lineHeight: 1.6, color: 'var(--aa-charcoal-800)' }}>
        <p style={{ marginTop: 0 }}><strong>1.</strong> The Authority shall reject the deduction of recoverable input tax if it is established that the supply in respect of which the deduction is claimed was part of a supply or a chain of supplies connected with tax evasion, and that the Taxable knew of such connection at the time of deducting the recoverable input tax.</p>
        <p><strong>2.</strong> The Authority may reject the deduction of recoverable input tax if it is established that the supply in respect of which the deduction is claimed was part of a supply or a chain of supplies connected with tax evasion, and that, having regard to the circumstances of the supply, the Taxable Person should have known of such connection.</p>
