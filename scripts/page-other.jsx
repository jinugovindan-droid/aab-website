...
function AboutPage({ onNav }) {
  ...
  { name: 'Johncy Mathew', role: 'Marketing Manager', bio: 'B.Com. Marketing strategist with 20+ years across the Gulf in retail and corporate marketing. Leads brand strategy, go-to-market planning and client relationship management — turning market insight into demand and durable positioning.' },
