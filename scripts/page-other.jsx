    ...
    <figure style={{ margin: '36px 0 40px' }}>
      <div style={{ overflowX: 'auto' }}>
        ...
        >
          ...
          <circle cx="60" cy="120" r="9" fill="#29ABE2" />
    ...
    <div className="container" style={ART}>
      ...
      <div style={{ background: 'var(--aa-surface-off)', border: '1px solid var(--aa-rule)', padding: 24, margin: '28px 0 8px' }}>
        ...
        <p style={{ margin: 0, fontSize: 15, color: 'var(--aa-charcoal)', lineHeight: 1.65 }}>
          At the time of writing (July 2026), every provider on the Ministry’s published list — 42 at its mid-July update — is <strong>pre-approved, not yet fully accredited</strong>; no Article-16 accredited register has been announced. Appointing from that list now is exactly what the deadlines anticipate, but make the engagement <strong>accreditation-contingent</strong>: full Article-16 accreditation comfortably before your go-live as a contractual milestone, with exit and migration rights — at no penalty to you — if it is missed. A provider that stalls at the technical stage must be their problem, not yours on go-live morning.
        </p>
        <p style={{ margin: '14px 0 0', fontSize: 15, color: 'var(--aa-charcoal)', lineHeight: 1.65 }}>
          <strong>Where to check, in practice:</strong> the public register is the MoF’s pre-approved list at <a href="https://mof.gov.ae/en/about-us/initiatives/einvoicing/pre-approved-einvoicing-service-providers/" target="_blank" rel="noopener" style={{ color: 'var(--aa-cyan-700)', fontWeight: 600 }}>mof.gov.ae</a>. Separately, registered businesses can already see the FTA’s operational list inside <strong>EmaraTax</strong> (e-Invoicing → onboarding) — the interface you will actually select and link your provider through. Note that the portal presents its list under an “Accredited Service Providers” heading even while the FTA notes provider onboarding is still in progress and the MoF register remains pre-approval — and the two lists do not yet fully match. Until the Ministry announces Article-16 accreditations, treat “accredited” claims with care, check both places at signing, and re-check before go-live.
        </p>
      </div>
